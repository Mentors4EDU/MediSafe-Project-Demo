...
Right now we have a custom Admin/Authentication pannel created with Cisco Spark for Demo purposes. The API we are using, which judges can have access to are hosted on a private [BitBucket.md]https://bitbucket.org/gamer456148/medibot-simulation/downloads/ repository as well as some hardware code and different "demo servers".
### Prerequisites
